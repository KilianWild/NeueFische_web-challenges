...
const allCardsWithTagsHTMLOrJSThatAreBookmarked = cards.filter(
   (card) => (card.tags.includes("js") || card.tags.includes("html")) && card.isBookmarked == true,
);
console.log(allCardsThatAreNotBookmarked);
console.log(allCardsWithTagsHTMLOrJSThatAreBookmarked);

export { onlyCardWithIdTwo, allCardsWith3Tags, allCardsThatAreNotBookmarked, allCardsWithTagsHTMLOrJSThatAreBookmarked };
